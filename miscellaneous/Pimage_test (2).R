...
## SGAT, minimal example


library(SGAT)

## load "fit" from Movement.Rnw
load("C:\\Users\\michae_sum\\Documents\\GitHub\\tripEstimation_datacache\\SGAT_\\Movement_fit.Rdata")

pZ <- Pimage(fit$model$twilight, grid = SGAT:::.chaingrid(fit$z), Z = TRUE)
...
##source("C:\\Users\\michae_sum\\Documents\\GitHub\\SGAT\\R\\Pimage.R")
